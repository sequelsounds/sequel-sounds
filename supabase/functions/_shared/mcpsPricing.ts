// ⚠️ SHARED BY THE APP AND THE CODA FUNCTION (26 Sep 2026). The browser's
// MCPS wizard imports this through src/lib/mcpsPricing.ts; the coda edge
// function imports it directly, so a library estimate made through the Sequel
// connector is priced by exactly the same code as one made in the app. No
// imports, no network, no database — keep it that way or Deno and Vite stop
// agreeing on it. The proof is still scripts/verifyMcpsPricing.ts.
/**
